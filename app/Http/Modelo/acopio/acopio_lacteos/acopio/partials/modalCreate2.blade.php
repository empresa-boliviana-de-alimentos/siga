<div class="modal fade modal-fade-in-scale-up" data-backdrop="static" data-keyboard="false" id="myCreateAP" tabindex="-5">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                       ...
                       {!! Form::open(['id'=>'acopio'])!!}
                        <input id="token" name="csrf-token" type="hidden" value="{{ csrf_token() }}">
                            <input id="id" name="prsid" type="hidden" value="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="col-sm-12">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                {!! Form::text('aco_can', null, array('placeholder' => 'Ingrese Cantidad (Lts)','maxlength'=>'20','class' => 'form-control','id'=>'aco_can')) !!}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                         <div class="col-sm-12">
                                            <label>
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('aco_tra', null, array('placeholder' => 'Ingrese Municipio','maxlength'=>'50','class' => 'form-control','id'=>'aco_tra')) !!}
                                                </span>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <CENTER><h4 class="modal-title">PARAMETROS FÍSICOQUIMICOS</h4></CENTER>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('n_aci', null, array('placeholder' => '(0,13 -0,18 % a.l.) ','maxlength'=>'20','class' => 'form-control','id'=>'n_aci')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                               ...
                                               <span class="block input-icon input-icon-right">
                                                    {!! Form::text('n_ph', null, array('placeholder' => '(6,6 -6,8) ','maxlength'=>'20','class' => 'form-control','id'=>'n_ph')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('n_mgra', null, array('placeholder' => '(minimo 3,0 %) ','maxlength'=>'20','class' => 'form-control','id'=>'n_mgra')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                             <div class="col-sm-12">
                                                ...
                                                <select class="form-control" id="n_pant" name="n_pant">
                                                    <option value="1">+</option>
                                                    <option value="2">-</option> 
                                                </select>
                                            </div>
            ...
            <center>
             <!--   <button class="button button-glow button-rounded button-success" data-target="#modalpfq" data-toggle="modal"  type="button">
                    Registrar Parametros Fisico Químico 
                </button>
                <button class="button button-glow button-rounded button-warning" data-target="#modalpor" data-toggle="modal"  type="button">
...
<!--
<div class="modal fade modal-fade-in-scale-up" id="modalpfq" tabindex="-1" role="dialog" aria-hidden="false">
            ...
            <div class="modal-body modal_long">
                <input id="token" name="csrf-token" type="hidden" value="{{ csrf_token() }}">              
                    ...
                    <div class="form-group" align="center">
                        ...
                        {!!link_to('#',$title='Registrar', $attributes=['id'=>'registrofqp','class'=>'btn btn-responsive btn-success btn-sm'], $secure=null)!!}
                    </div>
...
-->
<!--
<div class="modal fade modal-fade-in-scale-up" id="modalpor" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> X </button>
