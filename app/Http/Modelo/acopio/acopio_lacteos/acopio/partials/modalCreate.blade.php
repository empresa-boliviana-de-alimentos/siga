<div class="modal fade modal-fade-in-scale-up" data-backdrop="static" data-keyboard="false" id="myCreateRCA" tabindex="-5">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title" id="modalLabelfade">
                    <center>REGISTRO ACOPIO LACTEOS POR PROVEEDOR</center>
                </h4>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                         <div class="col-sm-12">
                                            ...
                                            <input id="cod_nom" name="cod_nom" disabled="true">
                                    ...
                                    <div class="col-md-3">
                                        <div class="col-sm-12">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                {!! Form::text('aco_hrs', null, array('placeholder' => 'Ingrese Cantidad (Lts)','maxlength'=>'20','class' => 'form-control','id'=>'aco_hrs')) !!}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                  {!! Form::text('aco_tem', null, array('placeholder' => '(°c)','maxlength'=>'20','class' => 'form-control','id'=>'aco_tem')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('aco_sng', null, array('placeholder' => '(9,2 minimo %) ','maxlength'=>'20','class' => 'form-control','id'=>'aco_sng')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
