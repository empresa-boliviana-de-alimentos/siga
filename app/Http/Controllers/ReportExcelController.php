...
class ReportExcelController extends Controller
{
    ...
    public function imprimirExcelIngresoAlmacenInsumosMes($mes,$anio)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelIngresoAlmacenInsumosDia($dia,$mes,$anio)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelIngresoAlmacenInsumosRango($dia_inicio,$mes_inicio,$anio_inicio,$dia_fin,$mes_fin,$anio_fin)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelSalidasAlmacenInsumosMes($mes,$anio)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelSalidasAlmacenInsumosDia($dia,$mes,$anio)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelSalidasAlmacenInsumosRango($dia_inicio,$mes_inicio,$anio_inicio,$dia_fin,$mes_fin,$anio_fin)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelSolicitudesAlmacenInsumosDia($dia,$mes,$anio)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
    ...
    public function imprimirExcelSolicitudesAlmacenInsumosRango($dia_inicio,$mes_inicio,$anio_inicio,$dia_fin,$mes_fin,$anio_fin)
    {
        $id_usuario = Auth::user()->usr_id;
        $usr = Usuario::join('public._bp_personas as persona', 'public._bp_usuarios.usr_prs_id', '=', 'persona.prs_id')
                ->where('usr_id', $id_usuario)->first();
