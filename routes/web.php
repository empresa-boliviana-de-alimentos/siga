...
Route::group(['middleware' => ['auth']], function () {
	...
	Route::get('ReportePdfSolicitudGral', 'ReportController@RptSolicitudGeneral');
	Route::get('ReporteExcelSolicitudGral', 'ReportExcelController@RptSolicitudGeneralExcel');
	Route::get('ReportePdfSalidasGral', 'ReportController@RptSalidasGeneral');
	Route::get('ReporteExcelSalidasGral', 'ReportExcelController@RptSalidasGeneralExcel');
	...
	Route::get('ListaSolicitudAlmInsumos','insumo\insumo_reportes\gbInsumoReporteController@ListaSolicitudAlmInsumos');
	...
	Route::get('imprimirPdfSolicitudesAlmacenInsumosDia/{dia}/{mes}/{anio}','ReportController@imprimirPdfSolicitudesAlmacenInsumosDia');
	Route::get('imprimirPdfSolicitudesAlmacenInsumosRango/{dia_inicio}/{mes_inicio}/{anio_inicio}/{dia_fin}/{mes_fin}/{anio_fin}','ReportController@imprimirPdfSolicitudesAlmacenInsumosRango');
	Route::get('imprimirExcelSolicitudesAlmacenInsumosDia/{dia}/{mes}/{anio}','ReportExcelController@imprimirExcelSolicitudesAlmacenInsumosDia');
	Route::get('imprimirExcelSolicitudesAlmacenInsumosRango/{dia_inicio}/{mes_inicio}/{anio_inicio}/{dia_fin}/{mes_fin}/{anio_fin}','ReportExcelController@imprimirExcelSolicitudesAlmacenInsumosRango');
	...
	Route::get('imprimirPdfIngresosMesGeneralPt/{mes}/{anio}/{planta}','ReportController@reporteIngresoMesGeneralPt');
	...
	Route::put('ModificarCodProducto/{id}', 'comercial\DatoComercialController@modificarCodProducto');
	...
	Route::get('BoletaIngresoPv/{id}', 'ReportController@boletaIngresoPvComercial');
