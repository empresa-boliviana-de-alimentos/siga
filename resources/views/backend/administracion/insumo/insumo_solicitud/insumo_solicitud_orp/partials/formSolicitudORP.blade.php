...
<div class="row">
    <div class="col-md-12">
        <div class="container col-lg-12" style="background: white;">        
            ...
            <form action="{{ url('SoliOrdenProduccionCreate') }}" class="form-horizontal" method="GET">
                ...
                @endif
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <textarea type="text" value="" class="form-control" name="obs_usr_vodos"></textarea>
                                </div>
                            </div>
                        </div> 
                </div>               
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a class="btn btn-danger btn-lg" href="{{ url('SolOrpReceta') }}" type="button">
                            Cerrar
                            </a>
                            <!-- {!!link_to('#',$title='Registrar', $attributes=['id'=>'registro','class'=>'btn btn-success'], $secure=null)!!} -->
                            <input type="submit"  value="Enviar Almacen" class="btn btn-success btn-lg">
                            </div>
                        </div>
                    </div>
