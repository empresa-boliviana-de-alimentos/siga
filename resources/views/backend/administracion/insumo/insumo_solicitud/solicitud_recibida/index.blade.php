    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-7 text-center">
                <p class="panel-title">SOLICITUDES RECIBIDAS</p>
            </div>
                    ...
                    <ul class="nav nav-tabs">
                      <li class="active" id="tabsolReceta">
                          <a data-toggle="tab" href="#solReceta" class="btn btn-primary" style="font-size: 11px">
                              SOLICITUDES POR RECETAS
                          </a>
                      </li>
                        <li id="tabsolInsumo">
                            <a data-toggle="tab" href="#solInsumo" class="btn btn-warning" style="font-size: 11px">
                                SOLICITUDES POR INSUMOS
                            </a>
                        </li>
                        <li id="tabsolTraspaso">
                            <a data-toggle="tab" href="#solTraspaso" class="btn btn-success" style="font-size: 11px">
                                SOLICITUDES POR TRASPASO
                            </a>
                        </li>
                        <li id="tabsolMaquila">
                            <a data-toggle="tab" href="#solMaquila" class="btn btn-danger" style="font-size: 11px">
                                SOLICITUDES POR MAQUILA
                            </a>
                        </li>
                    </ul>
