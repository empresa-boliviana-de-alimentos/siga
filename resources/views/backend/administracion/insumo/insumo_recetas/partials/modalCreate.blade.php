                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                {!! Form::text('unidad_base', null, array('placeholder' => 'Unidad Base','class' => 'form-control','id'=>'unidad_base', 'style'=>'text-transform:uppercase;','placeholder'=>'BOLSAS, BOTELLAS, ETC.', 'onkeyup'=>'javascript:this.value=this.value.toUpperCase();')) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <tr class="items_columsReceta2">
                                            <td><select name="descripcion[]" class="form-control">
                                                    ...
                                                    @foreach($listarInsumo as $insumo)
                                                        <option value="{{$insumo->ins_codigo.'+'.$insumo->ins_desc.'+'.$insumo->ins_id}}">{{ $insumo->ins_codigo.' - '.$insumo->ins_desc.' - '.$insumo->unidad}}</option>
                                                    @endforeach
                                                </select>
