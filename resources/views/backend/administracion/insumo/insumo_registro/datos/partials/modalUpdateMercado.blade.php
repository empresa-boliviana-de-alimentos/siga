                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('nombreUni', null, array('placeholder' => 'Nombre Mercado','maxlength'=>'250','class' => 'form-control','id'=>'nomercado','style'=>'text-transform:uppercase;', 'onkeyup'=>'javascript:this.value=this.value.toUpperCase();')) !!}
                                                </span>  
                                            </div>
                                        </div>
                                    </div>
