                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('nombresublin', null, array('placeholder' => 'Nombre Sub-Linea','maxlength'=>'250','class' => 'form-control','id'=>'nombresublin', 'style'=>'text-transform:uppercase;', 'onkeyup'=>'javascript:this.value=this.value.toUpperCase();')) !!}
                                                </span>  
                                            </div>
                                        </div>
                                    </div>
