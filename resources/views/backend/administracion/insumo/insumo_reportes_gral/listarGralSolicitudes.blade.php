    ...
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                     <h4><label for="box-title">REPORTES SOLICITUDES GENERAL</label></h4>
                </div>
                <div class="col-md-2">
                </div>
                <div class="col-md-2">
