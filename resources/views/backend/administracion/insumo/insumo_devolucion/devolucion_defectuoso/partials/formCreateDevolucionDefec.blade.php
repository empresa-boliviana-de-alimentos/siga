    ...
    <div class="col-md-12">
        <div class="container col-lg-12" style="background: white;">        
            ...
            <div class="text-center">
                <h3 style="color:#2067b4"><strong>SOLICITUD DEVOLUCIÓN POR INSUMOS DEFECTUOSOS</strong></h3> 
            </div>
            <form action="{{ url('RegistroDevolucionDefectuosa') }}" class="form-horizontal" method="GET">
      	...
      	$.get('getDataDetOrprodInsPrima?orprod_id='+data.orprod_id, function(data_det){
	      	...
	      	for (i = 0; i < data_det.length; i++){
				...
				$("#TableRecetasBase").append('<tr class="items_columsReceta3">' + 
	                ...
	                '<td align="center" style="dislay: none;"><input type="text" name="obs_devo[]" class="form-control" value=""></input></td>'+
