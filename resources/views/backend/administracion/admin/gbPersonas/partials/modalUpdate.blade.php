                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                {!! Form::text('prs_direccion2', null, array('placeholder' => 'Ingrese dirección auxiliar','class' => 'form-control','id'=>'direccionaux1')) !!}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                {!! Form::text('prs_telefono', null, array('placeholder' => 'Ingrese telefono', 'class' => 'form-control','id'=>'telefono1')) !!}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <span class="block input-icon input-icon-right">
                                                {!! Form::text('prs_telefono2', null, array('placeholder' => 'Ingrese telefono auxiliar', 'class' => 'form-control','id'=>'telefonoaux21')) !!}
                                            </span>
                                        </div>
                                    </div>
                                </div>
