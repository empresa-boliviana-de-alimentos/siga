    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-3 text-right">
                <button class="btn pull-right btn-default" style="background: #616A6B"  data-target="#myCreateDestino" data-toggle="modal"><h6 style="color: white">+&nbsp;NUEVO DESTINO</h6></button>
            </div>
        </div>
    </div>
