                    ...
                    <input id="id" name="id_comunidad" type="hidden" value="">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('comunidad', null, array('placeholder' => 'Ingrese nombre comunidad','maxlength'=>'50','class' => 'form-control','id'=>'comunidad')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    ...
                                    <select name="id_municipio" class="form-control id_municipio" id="id_municipio" style="width: 100%"></select>
                                 </div>
                            </div>
                        </div>
                        </fieldset>
