...
@include('backend.administracion.acopio.acopio_miel.envio_almacen.partials.modalCreateEnvioMiel')
@include('backend.administracion.acopio.acopio_miel.envio_almacen.partials.modalBoletaEnvioMiel')
    ...
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                <button class="btn fa fa-plus-square pull-right btn-dark"  data-target="#myCreateMielEnvioAlm" data-toggle="modal">&nbsp;Nuevo Envio</button>
                </div>
            </div>
            </div>
        </div>
            ...
            <div class="box">
                <div class="box-header with-border"></div>
                    <div class="box-body">
                        ...
                        <table class="col-md-12 table-bordered table-striped table-condensed cf" id="lts-enviosalmacenMiel">
                            <thead class="cf">
                                <tr>
                                    <th>
                                        Operaciones
...
$(document).ready(function() {
    var table = $('#lts-enviosalmacenMiel').DataTable( {
        ...
        $("#envioMielAlm").click(function(){
            var route="/RegistroEnvioMielAlm";
            var token =$("#token").val();
              ...
              closeOnConfirm: true
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#iframeboletaEnvioAlmMiel').attr('src', 'boletaEnvioMielAlm/'+data.enval_id);
                        $('#myBoletaEnvioMielAlm').modal('show'); 
                        $("#myCreateMielEnvioAlm").modal('toggle');
                        // $('#lts-enviosalmacenMiel').DataTable().ajax.reload();
                        location.reload();
                    },
