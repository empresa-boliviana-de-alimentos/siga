                    ...
                    <input id="id" name="id_municipio" type="hidden" value="">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('municipio', 'muni', array('placeholder' => 'Ingrese dirección','maxlength'=>'50','class' => 'form-control','id'=>'municipio','onkeyup'=>'javascript:this.value=this.value.toUpperCase();')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
