...
@include('backend.administracion.acopio.acopio_lacteos.envioAlm.partials.modalCreateEnvio')
        ...
        <div class="box box-default box-solid">
            ...
            <div class="col-md-12">
                ...
                <?php  
                 ...
                 $fechact=date('Y-m-d');
                    if($fechact==$fecha and $plant==$planta2->enval_id_planta)
                     { 
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border"></div>
                    <div class="box-body">
                        <table class="col-md-12 table-bordered table-striped table-condensed cf" id="lts-enviosalmacenlac" style="width: 100%">
                            <thead class="cf">
                                <tr>
...
$(document).ready(function() {
    var table = $('#lts-enviosalmacenlac').DataTable( {
            "responsive": true,
            "processing": true,
            "serverSide": true,
            "ajax": "/AcopioLacteosEnvioAlm/create/",
            "columns":[
