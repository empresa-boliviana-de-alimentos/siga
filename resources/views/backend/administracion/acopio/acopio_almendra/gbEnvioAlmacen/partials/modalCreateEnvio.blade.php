                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('enval_cant_total', $cantidad_acopio, array('placeholder' => 'Ingrese Nombre(s) ','maxlength'=>'40','class' => 'form-control','id'=>'enval_cant_total','onkeyup'=>'javascript:this.value=this.value.toUpperCase();','readonly')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <span class="block input-icon input-icon-right">
                                                    {!! Form::text('enval_cost_total', $costo_total_acopio, array('placeholder' => 'Ingrese Apellido Paterno','maxlength'=>'15','class' => 'form-control','id'=>'enval_cost_total','onkeyup'=>'javascript:this.value=this.value.toUpperCase();','readonly')) !!}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
