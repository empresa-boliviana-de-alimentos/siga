...
<table>
    <tr>
      <td colspan="7" style="text-align:center;"><strong><h6>REPORTE SALIDA GENERAL</h6></strong></td>
    </tr>    
    <tr>
...
<table border="1">
  <thead class="table_head">    
   <tr>
      ...
      <td align="center" style="background-color: #808080; border: 1px solid #000000; vertical-align: middle;"><h6><strong>Fecha Salida</strong></h6></td>
      <td width="20" align="center" style="background-color: #808080; border: 1px solid #000000; vertical-align: middle;"><h6><strong>Tipo Salida</strong></h6></td>  
   </tr>     
  </thead>
  <tbody>
  <?php 
  ...
  ?>
    ...
    @foreach($detorprod as $key => $ig) {
      ...
      <tr>      
        ...
        <td align="center"><h6>{{date('d/m/Y',strtotime($ig->detorprod_modificado))}}</h6></td>
