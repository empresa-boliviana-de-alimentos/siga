...
<table>
    <tr>
      <td colspan="7" style="text-align:center;"><strong><h6>SOLICITUDES ALMACEN</h6></strong></td>
    </tr>  
    <tr>
      <td colspan="7" style="text-align:center;"><strong><h6>PLANTA: {{$planta->nombre_planta}}</h6></strong></td>
    </tr>    
    <tr>
      ...
      <td colspan="5"><h6>{{$fecha_inventario}}</h6></td>
   </tr>
</table>
<table border="1">
  <thead class="table_head">    
   <tr>
      ...
      <td width="8" align="center" style="background-color: #808080; border: 1px solid #000000; vertical-align: middle;"><h6><strong>Nro. ORP</strong></h6></td>
      ...
      <td width="20" align="center" style="background-color: #808080; border: 1px solid #000000; vertical-align: middle;"><h6><strong>Fecha Solicitud</strong></h6></td>
      <td width="20" align="center" style="background-color: #808080; border: 1px solid #000000; vertical-align: middle;"><h6><strong>Estado</strong></h6></td> 
   </tr>     
  </thead>
  <tbody>
  <?php 
  ...
  ?>
    @foreach($reg as $key => $ig) {
      ...
      <tr>      
        ...
        <td align="center"><h6>{{$ig->orprod_registrado}}</h6></td>
        <td align="center">
          <h6>
          @if($ig->orprod_nro_salida)
            APROBADO
          @else
            SIN APROBACIÓN
          @endif
