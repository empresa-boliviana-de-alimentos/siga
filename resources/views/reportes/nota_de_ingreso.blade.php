...
<table class="table-info w-100">
	...
	<tbody>
			...
			<tr class="text-sm">
				...
				<td class="text-center text-xxs uppercase font-bold px-1 py-1">{{ number_format($d->deting_cantidad,2,'.',',') }}</td>
				<td class="text-center text-xxs uppercase font-bold px-1 py-1">{{ number_format($d->deting_costo,2,'.',',') }}</td>
