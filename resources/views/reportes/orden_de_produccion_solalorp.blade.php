...
<table class="table-info align-top no-padding no-margins border">
    <tr>
        <td class="text-center bg-grey-darker text-xs text-white ">Observación Encargado Producción:</td>
        <td class="text-xs uppercase">{{$receta->orprod_obs_usr}}</td>
    </tr>
</table>
<br>
<table class="table-info align-top no-padding no-margins border">
    <tr>
        <td class="text-center bg-grey-darker text-xs text-white ">Observación Jefe Planta:</td>
        <td class="text-xs uppercase">{{$receta->orprod_obs_vo}}</td>
    </tr>
</table>
<br>
<table class="table-info align-top no-padding no-margins border">
    <tr>
        <td class="text-center bg-grey-darker text-xs text-white ">Observación Encargado Producción Planta:</td>
        <td class="text-xs uppercase">{{$receta->orprod_obs_vodos}}</td>
    </tr>
</table>
