...
<table class="table-info w-100">
	...
	<tbody>
			...
			<tr class="text-sm">
				...
				<td class="text-center text-xxs uppercase font-bold px-1 py-1">{{ $d->orprod_nro_salida}}</td>
				...
				<td class="text-center text-xxs uppercase font-bold px-1 py-1">{{ $d->orprod_fecha_vodos}}</td>
			</tr>
			@endforeach
	</tbody>
</table>
